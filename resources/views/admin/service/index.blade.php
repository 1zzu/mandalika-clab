                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('service_form') }}" class="btn btn-success btn-sm">add new <i class="bi bi-plus"></i></a>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <a class="btn btn-success btn-sm" href="service/edit/{{ $v->id_service }}">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-service" data-id="{{ $v->id_service }}">
...
@section('js')
    <script>
        $('#hapus-service').on('show.bs.modal', function(event){
            ...
            var url_delete = 'service/delete/'+id
