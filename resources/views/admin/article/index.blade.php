                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">Data Articles</h5>
                                <a href="{{ route('article_form') }}" class="btn btn-success btn-sm">add new <i class="bi bi-plus"></i></a>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <a class="btn btn-success btn-sm" href="article/edit/{{ $v->id_post }}">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-service" data-id="{{ $v->id_post }}">
...
@section('js')
    <script>
        $('#hapus-service').on('show.bs.modal', function(event){
            ...
            var url_delete = 'article/delete/'+id
