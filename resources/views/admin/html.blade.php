...
<head>
  ...
  <title>Admin - Mandalika Central Laboratory</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">MCLab</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/profile*') ? '' : 'collapsed' }}" href="">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/service*') ? '' : 'collapsed' }}" href="{{ route('service') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/article*') ? '' : 'collapsed' }}" href="{{ route('article') }}">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Mandalika Central Laboratoy</span></strong>. All Rights Reserved
    </div>
  </footer><!-- End Footer -->
